...
func TestSerialization(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			ExpectedString: "SESSION [sid:22446688,hid:0102030400000000000000000000000000000000000000000000000000000000,cipher:ECDHERSAAES128GCMSHA256,curve:SECT571K1]",
		},
		{
			Message: &messageData{
				Channel:        0x02,
